...
export default function NotFound() {
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center bg-[#F8FAFC] px-4 py-12 sm:py-16 md:py-20 relative">
            ...
            {/* Text Content */}
            <div className="text-center z-10 max-w-md mx-auto relative -mt-2 sm:-mt-4 lg:-mt-8 px-4">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                    <Button asChild className="bg-[#2563EB] hover:bg-blue-600 text-white rounded-lg px-6 sm:px-8 py-2 sm:py-2.5 h-auto text-xs sm:text-sm font-semibold shadow-lg shadow-blue-500/20 transition-all hover:translate-y-[-2px] w-full sm:w-auto">
                        <Link href="/">
                            Go to home
                        </Link>
                    </Button>
                    <Button asChild variant="outline" className="border-slate-300 text-slate-700 hover:bg-white hover:text-[#0B2545] rounded-lg px-6 sm:px-8 py-2 sm:py-2.5 h-auto text-xs sm:text-sm font-semibold hover:border-slate-400 transition-all bg-transparent w-full sm:w-auto">
