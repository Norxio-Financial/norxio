...
export default function Footer({ data, settings }: FooterProps) {
    ...
    return (
        <footer className="bg-[#0B2545] text-white pt-20 pb-12 relative overflow-hidden">
            {/* Background Watermark */}
            <div className="absolute bottom-[-3vw] left-1/2 -translate-x-1/2 text-[22vw] font-bold text-white/[0.02] pointer-events-none select-none leading-none whitespace-nowrap z-0">
                NORXIO
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 mb-16">
                    ...
                    <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-12">
                        {/* Company */}
                        <div>
                            <h3 className="text-[17px] font-medium mb-6 text-white">Company</h3>
                        ...
                        {/* Product */}
                        <div>
                            <h3 className="text-[17px] font-medium mb-6 text-white">Product</h3>
                            <ul className="space-y-4">
                        ...
                        {/* Resources */}
                        <div>
                            <h3 className="text-[17px] font-medium mb-6 text-white">Resources</h3>
                            <ul className="space-y-4">
                        ...
                        {/* Legal */}
                        <div>
                            <h3 className="text-[17px] font-medium mb-6 text-white">Legal</h3>
                            <ul className="space-y-4">
