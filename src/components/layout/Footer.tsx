...
export default function Footer(_props: FooterProps) {
    ...
    return (
        <footer className="bg-[#0B2545] text-white py-12 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 mb-16">
                    ...
                    <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-8">
                        {/* Company */}
                        <div>
                            <h3 className="text-[17px] font-medium mb-4 text-white">Company</h3>
                            <ul className="space-y-4">
                                {links.company.map((link) => (
                                    <li key={link.label}>
                                        <Link href={link.href} className="text-[#bfccdf] hover:text-white transition-colors text-sm">
                                            {link.label}
                                        </Link>
                                    </li>
                                ))}
                        ...
                        {/* Product */}
                        <div>
                            <h3 className="text-[17px] font-medium mb-4 text-white">Product</h3>
                            <ul className="space-y-4">
                        ...
                        {/* Resources */}
                        <div>
                            <h3 className="text-[17px] font-medium mb-4 text-white">Resources</h3>
                            <ul className="space-y-4">
                        ...
                        {/* Legal */}
                        <div>
                            <h3 className="text-[17px] font-medium mb-4 text-white">Legal</h3>
                            <ul className="space-y-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-8">
                    <h3 className="text-2xl font-semibold text-white">Follow us on social media</h3>
                    <div className="flex items-center gap-3">
                        ...
                        {/* Instagram */}
                        <a href="#" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6 fill-current" aria-label="Instagram" > <path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm0 1.5A4.25 4.25 0 0 0 3.5 7.75v8.5A4.25 4.25 0 0 0 7.75 20.5h8.5a4.25 4.25 0 0 0 4.25-4.25v-8.5A4.25 4.25 0 0 0 16.25 3.5h-8.5zm4.25 4a5.25 5.25 0 1 1 0 10.5 5.25 5.25 0 0 1 0-10.5zm0 1.5a3.75 3.75 0 1 0 0 7.5 3.75 3.75 0 0 0 0-7.5zm5.5-.75a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0z" /> </svg>
