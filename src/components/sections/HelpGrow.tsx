      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 sm:mb-10 lg:mb-12 gap-6">
          ...
          <div className="flex gap-2 sm:gap-3">
            <button
              className="w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 rounded-full bg-brand-blue flex items-center justify-center text-white hover:bg-brand-blue-hover transition-colors shadow-sm cursor-pointer"
                ...
                <div className="relative aspect-[4/3] rounded-[16px] sm:rounded-[20px] md:rounded-[24px] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5 md:p-6 flex flex-col items-start text-white rtl:items-end rtl:text-right">
                    ...
                    >
                      ...
                      <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 rounded-full bg-brand-blue flex items-center justify-center shadow-lg group-hover/link:bg-brand-blue-hover transition-colors">
