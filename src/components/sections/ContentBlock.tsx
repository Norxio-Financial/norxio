...
export default function ContentBlock({
  ...
  // In RTL mode, flip the image position logic
    ...
    <section className={cn("py-12 sm:py-16 md:py-20 lg:py-28 overflow-hidden", className)}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className={cn(
          ...
          effectivePosition === "left" ? "lg:grid-flow-dense" : ""
        )}>
          {/* Content */}
          <div className={cn(
            effectivePosition === "left" ? "lg:col-start-2" : "",
            isRTL ? "text-right" : ""
          )}>
            {badge && (
              <div className={cn(
                "inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 bg-blue-50 rounded-full mb-4 sm:mb-6",
            ...
            {ctaText && ctaLink && (
              <Link href={ctaLink}>
                <Button className="bg-brand-blue hover:bg-brand-blue-hover text-white px-6 sm:px-8 py-4 sm:py-5 lg:py-6 rounded-full text-sm sm:text-base font-medium">
                  {ctaText}
                </Button>
              </Link>
            )}
          ...
          <div className={cn(
            ...
            effectivePosition === "left" ? "lg:col-start-1" : ""
          )}>
            <Image
              src={image}
              alt={imageAlt}
